                        ...
                        messages=[
                            {
                                ...
                                "content": (
                                    ...
                                    "layer_type=Input,input=(32,32,3),output=(32,32,3),activation_fn=None,"
                                    "layer_fields=input_shape=(32,32,3)|"
                                    "layer_type=CNN,input=(32,32,3),output=(30,30,64),activation_fn=ReLU,"
                                    ...
                                    "layer_type=Dense,input=14400,output=128,activation_fn=ReLU, "
                                    "weight_initiations=Xavier Initialization,layer_fields=units=128|"
                                    "layer_type=Output,input=128,output=10,activation_fn=Softmax,"
